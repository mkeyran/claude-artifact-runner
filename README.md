...
- `src/`
  ...
  - `artifacts/`: Directory for Claude-generated components
...
1. Generate a React component using Claude's Artifacts feature
2. Create a new `.tsx` file in the `src/artifacts` directory
3. Paste the generated component code into the file
4. The component will be automatically discovered and available in the selector

Your component will appear in the dropdown menu and can be selected for viewing.
